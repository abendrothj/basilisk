...
def main():
    ...
    parser.add_argument("--epsilon", "-e", type=float, default=0.1, help="Perturbation magnitude (default: 0.1)")
    parser.add_argument("--iters", "-i", type=int, default=40, help="Number of PGD iterations (default: 40)")
